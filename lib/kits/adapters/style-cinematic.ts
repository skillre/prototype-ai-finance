/**
 * Kits 适配层 · cinematic · 由 `kits add` 生成（v0.1.0）
 *
 * ===========================================================================
 * 这个文件属于**产品**，不属于 Kits。
 * ===========================================================================
...
import {
  ...
  cinematicProfile,
  cinematicMeta,
} from "../installed/cinematic/index";
 ...
 */
export const stylePackId = "cinematic" as const;

/** pack 的动效刻度（TS 形态）。改它不会影响视觉，视觉走下面的 CSS 变量。 */
export const stylePackMotion = cinematicMotion;
...
/** pack 的视觉性格画像（十个维度）。 */
export const stylePackProfile = cinematicProfile;

/** pack 的元信息：id / name / selector / cssEntry。 */
export const stylePackMeta = cinematicMeta;

/** 声明 pack 作用域要用的选择器（等价于 `[data-kits-pack="cinematic"]`）。 */
